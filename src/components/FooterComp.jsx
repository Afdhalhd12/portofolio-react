        ...
        <div className="mt-25">
            <section className="mb-5">
                <div className="hidden lg:flex absolute left-1 top-555 -translate-y-1/2 items-center gap-2">
                    <div className="rotate-90 font-bold font-anton text-xl lg:text-2xl">
                        Contact <span className="text-gray-400">-</span>{" "}
                        <span className="text-amber-500">05</span>
                    </div>
                </div>
                <div data-aos="fade-up" className="text-center">
                    <h1 className="text-5xl font-anton">Contacts</h1>
                    <h6 className="font-roboto">Nice to see you here!</h6>
            ...
            <footer className="mt-10">
                ...
                <p className="text-gray-400 mt-5 text-center font-roboto">© 2026 Afdhal Hadi Solahudin.</p>
            </footer>
        </div>
